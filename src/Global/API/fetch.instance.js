 ...
 *
 * @property {number} timeout - 요청 timeout을 5000ms(5초)로 설정
 * @property {Object} headers - 기본 요청 headers를 설정, 기본적으로 `Content-Type: application/json`을 포함한다.
 *
